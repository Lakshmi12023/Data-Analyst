...
with open(r'C:\Users\laksh\Project\rf_model.pkl', 'rb') as f:
    model = pickle.load(f)

with open(r'C:\Users\laksh\Project\s.pkl', 'rb') as f:
    scaler = pickle.load(f)

with open(r'C:\Users\laksh\Project\ohe.pkl', 'rb') as f:
    encoder = pickle.load(f)

with open(r'C:\Users\laksh\Project\feature_names.pkl', 'rb') as f:
...
st.markdown(f'''The Telecom Churn Prediction App analyses customer behaviour to predict churn. Users enter appropriate selections to get results. The findings are obtained using a trained model, which provides forecasts and predictions. These forecasts are the result of training the model with qualities and characteristics from both churners and non-churners.
''')
